...
#Форматированный вывод информации о системе с применением цветов
...
#Форматированный вывод информации о примененых цветах

echo "Column 1 background = $column1_background $fon_color1"
echo "Column 1 font color = $column1_font_color $shrift_color1"
echo "Column 2 background = $column2_background $fon_color2"
echo "Column 2 font color = $column2_font_color $shrift_color2"
